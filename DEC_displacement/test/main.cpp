...
int main(int argc, const char * argv[]) {
    ...
    TxtOption TxtOption;
    TxtOption.fileName = "/Volumes/A/DEC_robotic/DEC/hikcamera/test/info.txt";
    
    Client socket;
    socket.IP = "127.0.0.1";
    socket.SERV_PORT = 9999;
    socket.clientLink();
    ...
    int model;
    string info_model = "please choose model (0 = 标定, 1 = HikCam检测， 2 = HikCam对焦， 3 = usbCam检测， 4 = usbCam对焦) : ";
    std::cout << info_model << endl;
    socket.clientWrite(info_model);
    std::cin >> model;
     
    int pointNO;
    string info_point = "please choose whice point to detect. (1-9)";
